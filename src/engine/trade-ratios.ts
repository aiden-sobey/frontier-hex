 ...
 * - 4:1 default
 */
export function getTradeRatio(state: GameState, playerIndex: number, resource: ResourceType): number {
 ...
 */
export function getAllTradeRatios(state: GameState, playerIndex: number): Record<ResourceType, number> {
  return {
