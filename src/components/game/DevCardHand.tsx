  ...
  return (
    <div>
      <button
        ...
        className="w-full cursor-pointer rounded bg-gray-800 px-3 py-2 text-left transition-colors hover:bg-gray-700"
      >
        <span className="text-sm font-medium">Dev Cards</span>
        <span className="ml-2 text-xs text-gray-400">({totalCards})</span>
      </button>
      ...
      >
        {yopPicking ? (
          ...
          <p className="text-sm text-gray-400">No development cards in hand.</p>
        ) : (
                ...
                >
                  <div className="flex-1">
                    <div className="text-sm font-medium">
                      {info.label}
                      <span className="ml-1 text-gray-400">x{count}</span>
                      {newCount > 0 && (
                        <span className="ml-1 text-xs text-yellow-500">({newCount} new)</span>
                      )}
                    </div>
